...
## Brand-Statements (UX-R1 bis UX-R6, 03.06.2026)

**Editorial-Industrial bis ins Innere.** Das Editorial-Industrial-Versprechen, das Login, Landing und 404 seit dem High-End-Sprint einlösen (Doppelrand-Bezel, Magnetic-CTAs, film-grain, Barlow-Condensed-Display), endete bisher an der App-Tür. UX-R1 bis UX-R6 ziehen diese Haltung ins Innere: `PageHero` wird zum Pflicht-Primitive auf jedem Hot-Path (Bestellungen-Liste, Detail, Buchhaltung, Dashboard, Archiv) und ersetzt die alten generischen `<h1>`-Header durch Eyebrow + Display-Headline + Subline + Action-Slot mit corner-marks/industrial-line. `EditorialSection` wird als Foundation-Primitive für vertikalen Rhythmus etabliert — eine geteilte Sprache für Section-Trennung, statt 9 lokale Varianten. `BestellnummerHero` macht die Bestellnummer auf der Detail-Page zum Display-Numeral (Barlow Condensed, tabular-nums, große Type-Scale) — die zentrale Identität der Page, nicht ein Listeneintrag. Drei-Sprachen-Disziplin v2 (Body DM Sans / Display Barlow Condensed / Numeric JetBrains Mono) bekommt **Visual-Weight-Stufen 1-3** für Badges/Pills/Tags: Stufe 1 = strukturell (Status), Stufe 2 = informativ (Vendor/Typ), Stufe 3 = atmosphärisch (muted Meta). Verhindert die schleichende Pill-Inflation, bei der jede Information sich gleich laut meldet.

**Posteingang-Mentalität für Bestellungen.** UX-R2 ist die größte IA-Entscheidung des Sprints: die 4 Owner-Tabs (Pool / Meine offen / Meine erledigt / Alle) werden durch **3 Lanes** ersetzt — `Pool`, `In Arbeit`, `Archiv`. Der Hot-Path orientiert sich damit nicht mehr an „wem gehört das" sondern an „wo im Lebenszyklus ist das". **Pool ist kollaborative Triage** — alles ohne Owner ist eine geteilte Aufgabe für alle Besteller, nicht nur eine UNBEKANNT-Sonderkategorie. **In Arbeit** ist die persönliche Working-Surface mit Owner-Filter, **Archiv** ist die Recherche-Lane für freigegebene/verworfene/bezahlte Items. **Cmd+K als Cross-Lane-Search** macht den Lane-Wechsel optional — wer eine Bestellnummer kennt, springt direkt, ohne erst die richtige Lane zu raten. Das Produkt bekommt damit Posteingang-DNA: Inbox-Zero-Mentalität, gemeinsame Triage, Tastatur-First. Es ist keine „Liste mit Filtern" mehr, sondern ein Posteingang für Geschäftsdokumente — mit allem was diese Mental-Model-Verschiebung an Klarheit bringt.
