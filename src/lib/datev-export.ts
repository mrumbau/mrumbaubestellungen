...
export function exportiereAlsDATEV(
  ...
  const zeilen = rechnungen.map((r) => {
    ...
    // Subunternehmer: 4800 (Fremdleistungen), Abo: 4900 (lfd. Betriebskosten), Material: übergebenes Gegenkonto
    const zeilenGegenKonto = r.bestellungsart === "subunternehmer" ? "4800" : r.bestellungsart === "abo" ? "4900" : gegenKonto;
