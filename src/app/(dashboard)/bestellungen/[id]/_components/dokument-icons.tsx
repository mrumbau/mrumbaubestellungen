 ...
 *
 * Kept separate from the global icon catalog (@/components/ui/icons) because these
 * are semantic illustrations of invoice/delivery-note/order-confirmation — not
 * generic action icons. Same stroke weight and viewBox discipline as the global set.
 */
...
export function BestellIcon(props: SVG) {
  return (
...
export function LieferscheinIcon(props: SVG) {
  return (
    <svg viewBox="0 0 24 24" {...iconProps} {...props}>
...
export function RechnungIcon(props: SVG) {
  return (
    <svg viewBox="0 0 24 24" {...iconProps} {...props}>
...
export function VersandIcon(props: SVG) {
  return (
    <svg viewBox="0 0 24 24" {...iconProps} {...props}>
...
export const DOK_ICON_MAP: Record<string, (props: SVG) => React.JSX.Element> = {
