...
/**
 * In-Arbeit-Lane (UX-R2) — persönliche aktive Bestellungen.
 * Gleiche Stabilitäts-Strategie wie Pool-Page: loadLaneDataSafe + try-catch
 * + EmptyState.
 */
export default async function InArbeitLanePage({
  ...
  try {
    ...
    return <LanePageCrashFallback err={err} laneLabel="In Arbeit" />;
  }
}
