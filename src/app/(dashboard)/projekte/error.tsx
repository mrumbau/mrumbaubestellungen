...
export default function ProjekteError({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-24">
      ...
      <h2 className="font-headline text-lead text-foreground mb-1">Projekte konnten nicht geladen werden</h2>
      <p className="text-body-sm text-foreground-subtle mb-6">Bitte versuche es erneut.</p>
      <button
        onClick={reset}
