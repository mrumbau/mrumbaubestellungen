...
export default async function Home() {
  ...
  return (
    <div className="min-h-dvh flex flex-col lg:flex-row">
      ...
      >
        {/* Hover overlay */}
        <div className="absolute inset-0 bg-cs-accent/[0.02] opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
        {/* Dot grid pattern */}
        ...
        <div className="relative z-10 max-w-md">
          ...
          <div className="w-12 h-[2px] bg-cs-accent/20 mt-5 mb-4" />
        ...
        <div className="relative z-10 flex items-center justify-between">
          <span className="text-white/15 text-[10px] tracking-[0.15em] uppercase font-mono-amount">Öffnen</span>
          <div className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center group-hover:border-cs-accent/30 group-hover:bg-cs-accent/[0.06] transition-all">
            <svg className="w-4 h-4 text-white/30 group-hover:text-cs-accent-light/70 group-hover:translate-x-0.5 transition-all" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 4.5L21 12m0 0l-7.5 7.5M21 12H3" />
            </svg>
          </div>
        </div>
