 ...
 *
 * Variance-Engine:
 *   Vibe = Editorial Luxury (Warm Industrial) — Espresso MR-Red.
 *   Layout = Vollflächiges Panel mit Z-Axis-Cascade-Inside — floating
 *            Doppelrand-Glasplaketten-Content-Block + Bottom-CTA-Pille mit
 *            Button-in-Button.
 *
 * 21.09.2026 — war ursprünglich ein Editorial-Split mit zwei Modul-Panels.
 * Mit dem Entfernen des CardScan-Moduls bleibt nur noch Modul 01, das Panel
 * füllt jetzt die volle Breite.
 *
 * Design-Patterns:
  ...
  return (
    <div className="min-h-dvh flex flex-col lg:flex-row">
      ...
      <Link
        ...
        className="group relative flex-1 flex flex-col justify-between px-5 py-8 sm:p-8 md:p-12 lg:p-16 bg-mr-gradient overflow-hidden min-h-dvh focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/40"
      >
