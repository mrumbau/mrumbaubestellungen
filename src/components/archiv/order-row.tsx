    ...
    <>
      ...
      >
        ...
        <td className="px-4 py-3.5 hidden md:table-cell">
          {order.projekt_name ? (
            <span className="text-meta text-foreground-muted">{order.projekt_name}</span>
          ) : (
              ...
              <div className="flex items-start justify-between gap-6">
                ...
                <div className="flex-1">
                  ...
                  {docs.length > 0 ? (
                    <div className="flex flex-wrap gap-2">
                      {docs.map((dok) => (
                        ...
                        >
                          ...
                          <span className="text-meta font-medium text-foreground capitalize">{dok.typ}</span>
                    ...
                    <span className="text-meta text-foreground-faint">Keine Dokumente vorhanden</span>
                  )}
                </div>
                ...
                <Link
                  ...
                  prefetch={false}
                  onClick={(e) => e.stopPropagation()}
                  className="flex items-center gap-1.5 px-3 py-1.5 text-meta text-brand hover:text-brand-light font-medium border border-line rounded-lg hover:bg-surface transition-colors shrink-0 group/link"
                >
                  Details
                  <svg
